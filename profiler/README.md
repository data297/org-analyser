...
anything else — the image bundles them all. From inside `repo_pipeline/profiler/` (where
...
**5. Set up this project.** This tool is the `repo_pipeline.profiler` subpackage of the
bigger `repo-pipeline` project — install from the repo root, not this folder:

```bash
cd ~/Coding/repo-pipeline
