#!/usr/bin/env python3
"""
Read all repo_evaluator.py JSON output files and fill a vendor "Seller -
Codebase Input Template" CSV.
...
# ──────────────────────────────────────────────────────────────────────────────
# Template columns — a sample vendor intake schema. Swap this list for your
# own vendor's column headers; the rest of the script just maps computed
# fields onto whatever names are listed here.
# ──────────────────────────────────────────────────────────────────────────────

EXAMPLE_TEMPLATE_COLUMNS = [
    "Project Name",
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Fill a vendor repo evaluation template CSV from JSON results.",
    ...
    with open(args.output, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(f, fieldnames=EXAMPLE_TEMPLATE_COLUMNS)
        writer.writeheader()
